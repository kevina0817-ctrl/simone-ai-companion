    ...
    <>
      <article className="mt-4 rounded-3xl bg-card/70 p-5 shadow-card">
        ...
        <div className="mt-4 flex gap-2">
          <button className="flex-1 rounded-full border border-border bg-secondary/50 py-2.5 text-sm font-medium">Decline</button>
          <button className="flex-1 rounded-full bg-primary py-2.5 text-sm font-semibold text-primary-foreground shadow-glow">Approve</button>
        </div>
      </article>
